      ...
      <section id="about-page" className="page">
        ...
        <section className="about section">
          ...
          <p>
            ...
            better knowledge of concepts and technologies I use. I was initially
            drawn to Processing and the creative coding process to generate{' '}
            <a
          ...
          <p>
            ...
            creative process which for me involves both (visual and sonic)
            design and code.
          </p>
